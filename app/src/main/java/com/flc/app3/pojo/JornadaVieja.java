...
public class JornadaVieja {
    ...
    public JornadaVieja(String nombre, String ej1, String ej2, String ej3, String ej4, String e5, String pts, String comment, boolean jugada) {
        this.nombre = nombre;
        this.ej1 = ej1;
        this.ej2 = ej2;
        this.ej3 = ej3;
