...
public class FragmentEjercitos extends Fragment {

    public FragmentEjercitos() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_ejercitos, container, false);

        TextView ejemplo = (TextView)v.findViewById(R.id.textViewEjemplo);
        ejemplo.setText("Ejércitos");
